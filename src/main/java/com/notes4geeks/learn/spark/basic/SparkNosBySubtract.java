...
public class SparkNosBySubtract {
...
String master = args.length > 0 ? args[0] : "local[4]";
		...
		JavaRDD<Integer> allNos = oddNos.intersection(evenNos);
		
		System.out.println("printing intersection of even and odd nos, will return nothing.");
